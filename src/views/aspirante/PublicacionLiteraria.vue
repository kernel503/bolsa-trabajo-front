  ...
  <v-container>
    <v-layout align-center justify-center>
      <v-flex xs12 sm12 md8>
        <p class="text-h6 mb-2">Publicaciones literarias</p>
        <v-divider></v-divider>
          ...
          <v-row>
            <v-col class="my-0 py-2">
              <AutoCompleteApi
                ...
                label="Categoria publicación"
                text="nombre"
                idvalue="idPublicacionCategoria"
                v-model="formData.idPublicacionCategoria"
              />
            </v-col>
          </v-row>
          ...
          <template v-for="item in list">
            <v-list-item :key="item.idPublicacionLiteraria">
              ...
              <v-list-item-icon>
                <v-icon
                  color="red"
                  @click="deleteInformation(item.idPublicacionLiteraria)"
                >
                  mdi-delete
                </v-icon>
              </v-list-item-icon>
...
export default {
  ...
  data() {
    return {
      ...
      urlBase: "/publicacion/literaria/",
      formData: {
        idCv: this.$store.state.idCv,
        idPublicacionCategoria: "",
        fechaPublicacion: "",
        nombre: "",
        ciudad: "",
        isbn: "",
